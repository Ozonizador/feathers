    ...
    return (
        ...
        <section>
            <div className="background-banner">
                ...
                <div className="flex flex-col py-96 justify-center align-middle items-center">
                    <div className="text-white rounded-full bg-primary-300 px-7 py-3 mb-7 text-xl">SENHORIO</div>
                    <h1 className="text-6xl text-white w-3/4 text-center font-bold">5 FORMAS DE MELHORAR O CONSUMO ENERGÉTICO DA SUA CASA</h1>
                    <p className="text-2xl text-white text-center mt-14">BY UNIHOST ON FEBRUARY 02, 2022</p>
                </div>
            </div>
            ...
            <div className="container mx-auto px-32">
                ...
                <div className="font-bold text-3xl">1. OPTE POR UMA FONTE DE ENERGIA MAIS VERDE</div>
                ...
                <div className="font-bold text-3xl">2. TENHA EM CONSIDERAÇÃO A EXPOSIÇÃO SOLAR</div>
                <p className="text-2xl mt-7 mb-24">
                ...
                <div className="font-bold text-3xl">3. INSTALE LÂMPADAS DE BAIXO CONUSMO</div>
                <p className="text-2xl mt-7 mb-24">
                ...
                <div className="font-bold text-3xl">4. REFORCE O ISOLAMENTO TÉRMICO</div>
                <p className="text-2xl mt-7 mb-24">
                ...
                <div className="font-bold text-3xl">5. POUPE ÁGUA</div>
                <p className="text-2xl mt-7 mb-24">
