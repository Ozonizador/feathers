...
const DicasConsumoCards = () => {
    return (
        ...
        <section>
            ...
            <div className="container mx-auto px-32 mb-32">
                ...
                <div className="flex">
                    ...
                    <div className="flex flex-1 flex-col">
                        ...
                        <div className="w-2/3">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo.</div>

                        <div className="flex justify-between w-4/6 text-base text-gray-400 mt-10">
