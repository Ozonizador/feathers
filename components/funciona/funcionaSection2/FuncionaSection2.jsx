        ...
        <section className="container mx-auto my-20">
            ...
            <div className="container flex flex-row justify-between  mx-auto  ">
                <FuncionaSection2Card  
                  img="/images/22.png" icon="/images/2.png" heading="Defina as condições de arrendamento"
            ...
            <div className="container flex flex-row justify-between  mx-auto  ">
                <FuncionaSection2Card  
                  img="/images/33.png" icon="/images/3.png" heading="Adicione fotografias da propriedade"
            ...
            <div className="container flex flex-row justify-between  mx-auto  ">
                <FuncionaSection2Card  
                  img="/images/44.png" icon="/images/4.png" heading="Receba pedidos de reserva"
            ...
            <div className="container flex flex-row justify-between  mx-auto  ">
                <FuncionaSection2Card  
                  img="/images/55.png" icon="/images/5.png" heading="Reserva confirmada"
            ...
            <div className="container flex flex-row justify-between  mx-auto  ">
                <FuncionaSection2Card  
                  img="/images/66.png" icon="/images/6.png" heading="Receba os seus novos inquilinos"
            ...
            <div className="container flex flex-row justify-between  mx-auto  ">
                <FuncionaSection2Card  
                  img="/images/77.png" icon="/images/7.png" heading="Receba o seu primeiro pagamento"
            ...
            <Link href="" className="mb-24">
                <a className="bg-primary-500   py-3 text-white rounded-md flex justify-center w-52 mx-auto duration-200 ease-in  hover:drop-shadow-xl hover:text-white">Criar o anúncio</a>
            </Link>
