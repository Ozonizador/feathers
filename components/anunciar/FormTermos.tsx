          ...
          <div className="mt-10 flex flex-col gap-5">
            <div className="flex flex-row items-center align-middle">
              <div className="flex flex-row items-center gap-4">
                ...
                ></Controller>
                <Link href={"/terms"} target="_blank" rel="noopener noreferrer" className="text-md capitalize underline">{t("terms_and_conditions")}</Link>
              </div>
            </div>
            ...
            <div className="flex flex-row items-center align-middle">
              <div className="flex flex-row items-center gap-4">
                ...
                <Link href={"/policies"} target="_blank" rel="noopener noreferrer" className="text-md capitalize underline">{t("privacy_policy")}</Link>
              </div>
            </div>
