  ...
  return (
    <section className="container mx-auto w-5/6 my-20">
      <div className="w-full">
        <div className="block text-2xl text-gray-700 font-bold mb-4">
          Carregue fotos para o seu anúncio ser mais apelativo e o estudante saber exatamente o que esperar.<br />(mín. 5 fotos)
        </div>


        <div>

          <div className=" flex justify-center border-2 border-terciary-500 border-dashed rounded-md py-28 mt-10">
            <div className="space-y-1 text-center">
              ...
              <div className="flex  text-terciary-700">
                ...
                <label className="relative cursor-pointer bg-white rounded-md text-indigo-500">
                  <span>Download</span>
