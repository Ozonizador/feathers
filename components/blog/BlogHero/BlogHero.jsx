    ...
    return (
        ...
        <section className="container mx-auto py-20">
            ...
            <div className="flex  justify-between  gap-14">
                <article className="relative h-96 w-2/6  rounded-lg  bg-about-1 px-7">
                    <div className="absolute bottom-7 left-6 w-3/4">
                        <h2 className="bold  text-2xl text-white font-normal ">5 estratégias para inovar no seu anúncio</h2>
                    </div>
                </article>

                <article className="relative h-96 w-2/6  rounded-lg  bg-about-2 px-7">
                    <div className="absolute bottom-8  left-6 w-3/4">
                ...
                <article className="relative h-96 w-2/6  rounded-lg  bg-about-3 px-7">
                    <div className="absolute bottom-7 left-6 w-3/4">
