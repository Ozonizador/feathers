...
export default function TestemunhoCard({ img, testimonial, name }: TestemunhoCardProps) {
  return (
    <article className="mx-auto w-fit max-w-[320px] rounded-xl bg-white px-4 py-2 lg:mb-8 lg:w-full test-card">
      <div className="h-2/3">
        <div>
          <Image height={32} width={32} src="/images/icon-quotest.svg" alt="" className="rounded-lg py-4" />
          <p className="xl:text-[16px] lg:text-[15px] text-[15px] ">{testimonial}</p>
        </div>
      </div>
      <div className="mt-6 xl:mt-10 flex items-center">
