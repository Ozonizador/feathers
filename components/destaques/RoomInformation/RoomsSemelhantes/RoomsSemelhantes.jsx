...
export default function RoomSemelhantes() {
    return (
        <section className="mb-40">
            ...
            <div className="grid w-3/5 lg:grid-cols-4 justify-start gap-48 mb-10">
                <article className="relative h-56 w-56  rounded-lg  bg-destaques-slider1 ">
                ...
                <article className="relative h-56 w-56  rounded-lg bg-destaques-slider2">
