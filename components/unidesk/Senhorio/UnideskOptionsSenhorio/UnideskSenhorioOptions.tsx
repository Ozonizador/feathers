...
const UnideskOptions = () => {
  return (
    <section className="container mx-auto my-32 flex flex-col gap-7 lg:flex-row">
      {/* OPTION1*/}
      <div className="flex flex-col gap-5 rounded-2xl bg-white p-5 pb-10 drop-shadow-2xl lg:w-2/6">
        ...
        <div className="flex flex-col justify-start">
          <Link href="unidesk/senhorio/advertisements">
            <a className="text-xl font-bold">Painel</a>
          </Link>
          {/*<MyDropdown />*/}
        </div>
        <div className="flex flex-row">
          <Image className="object-scale-down" src="/images/icon-pg14-5.svg" alt="" height="25" width="25"></Image>
          <p className="my-auto ml-2 text-base">Informações contratuais</p>
        </div>
        <Link href="/unidesk/senhorio/reservas">
          <a className="text-xl font-bold">Reservas</a>
        </Link>
        <Link href="unidesk/senhorio/calendar">
          <a className="text-xl font-bold">Calendário</a>
        </Link>
      ...
      <div className="flex flex-col gap-5 rounded-2xl bg-white p-5 pb-10 drop-shadow-2xl lg:w-2/6">
        ...
        <div className="mt-2 flex flex-col justify-start gap-5">
