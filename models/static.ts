export interface TestemunhoInfo {
  description: string;
  image: string;
  host: string;
  job: string;
...
export const Testemunhos: TestemunhoInfo[] = [
  {
    description: `Com a UniHosts foi tudo mais fácil! Sempre tive alguma dificuldade para encontrar inquilinos
...
eficiente e eficaz encher a minha casa!`,
  ...
  {
    description: `Enquanto Senhorio foi muito prático para comunicar o meu alojamento! Intuitivo e a
  ...
  {
    description: `Tinha o objetivo de apenas alugar os quartos que tinha disponíveis e foi muito simples.
  ...
  {
    description: `No ínicio estava um pouco reticente por colocar a minha casa na plataforma. Com o tempo
