...
export enum NotificationType {
  STUDENT_RESERVATION_DECLINED = "STUDENT_RESERVATION_DECLINED", // trigger done
  STUDENT_RESERVATION_ACCEPTED = "STUDENT_RESERVATION_ACCEPTED", // trigger done
  ...
  LANDLORD_RESERVATION_RECEIVED = "LANDLORD_RESERVATION_RECEIVED", // trigger done
