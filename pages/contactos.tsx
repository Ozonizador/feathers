    ...
    <>
      <div className="container mx-auto my-20 w-full px-7 lg:container lg:my-20 lg:w-full  lg:px-0 ">
        <div className="flex flex-col lg:flex-row ">
          ...
          <div className="mt-10 w-full lg:mt-0 lg:w-2/4">
            ...
            <button className="my-10 flex w-full items-center justify-center rounded-md bg-primary-500 py-4  px-9 text-center uppercase  leading-tight text-white shadow-md transition duration-150 ease-in-out hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg lg:w-32">
              Enviar
            </button>
          </div>
        </div>
